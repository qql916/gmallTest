...
public class ListServiceImpl implements ListService {
    public static final String index_name_gmall = "gmall0725";

    public static final String type_name_gmall = "SkuLsInfo";
    ...
    public List<SkuLsInfo> search(SkuLsParam skuLsParam) {
        ...
        if (groupby_attr!=null){
            ...
            for (TermsAggregation.Entry bucket : buckets) {
                //去聚合函数
                attrValueIdList.add(bucket.getKey()); //聚合的字段值，id
                Long count = bucket.getCount();//聚合的次数
            }
        }
